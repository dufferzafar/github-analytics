...
\subsubsection{When do commits happen?}

To find out if there is a correlation between time of day and number of commits, we plotted a punchcard (Figure 5)
which shows that most of the commits happen during Weekdays between 8am - 8pm.

\begin{figure}[htb]
\centering
\includegraphics[scale=0.40]{commits-punchcard-overall}
\caption{When do commits happen?}
\small{Mon-Fri between 8am \& 8pm!}
\end{figure}
