...
We used \fnurl{xsv}{https://github.com/BurntSushi/xsv/}, a command line CSV parsing tool, to remove columns that contained redundant information which reduced the size of the files. \\
