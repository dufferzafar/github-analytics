...
From \code{commits.csv}, we removed the sha (160 bits) field which was the hash value associated with each commit. This lead to a significant reduction in the size of the file from 68.8 GB to 37.6 GB (nearly 55\%) size of the table. \\
